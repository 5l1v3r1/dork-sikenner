...
\t https://t.me/spyhackerz_org
"""
print (banner)
headers = {"User-Agent": "Mozilla/5.0 (Windows NT 6.1; rv:57.0) Gecko/20100101 Firefox/57.0"}
print ("""
1. Bing Dorker Random Domains
2. Get Weblist From IP [ BUNLARI S.ET ]
3. Get IP From Website [ BUNLARI S.ET ]
4. Add HTTP On All Weblist [ BUNLARI S.ET ]
5. URL List Cleaner [ BUNLARI S.ET ]
""")

nels = raw_input(" spyhackerz.org@gmail.com.tr:~# ")

class males():
	#def alldomains(self):
		#iya = raw_input("Dork List :  ")
		#iya = open(iya, 'r')
			...
			while tu < 159:
				...
				for i in sip:
					...
					if (o[0]+'//'+o[2]) in sa:
						...
						sa.append(o[0]+'//'+o[2])
						print '[ CATUR CUTUR ] -> ',(o[0]+'//'+o[2])
						with open('kardesimbutoolcokguzel.txt', 'a') as s:
							s.writelines((o[0]+'//'+o[2])+'\n')
				tu = tu+50


	def grabip(self):
		ooke = raw_input("IP List : ")
		ooke = open(ooke, 'r')
		for zzz in ooke:
			bo = []
			lonk = 1
	...
	def http(self):
		kep = raw_input("SITE List : ")
		kep = open(kep, 'r')
		for i in kep:
			i = i.rstrip()
			print("http://"+i)
			with open('neleroluyorhayatta.txt', 'a') as o:
				o.write("http://" + i + '\n')
		print("[>>] D0N3! Check neleroluyorhayatta.txt")
